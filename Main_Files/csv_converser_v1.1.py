...
file = open("sent\comentarios_bruto.txt", "r", encoding="UTF-8")
...
while linha != "":
    ...
    linha = file.readline()
print(df)
df.to_csv('sent\comentarios.csv', index=False)
print("Os comentários foram tokenizados e importados para um arquivo .csv!")import pandas as pd
import nltk as nk
import re
